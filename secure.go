...
type Options struct {
	...
	SSLHost string
	// If UseXForwardedHost is set to true, then use the value of X-Forwarded-Host request header as SSLHost if it exists. The SSLHost option overrides this behavior. Default is false.
